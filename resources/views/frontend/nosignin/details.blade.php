...
@section('content')
	...
	<div class="home">
		...
		<div class="home_background" style="background-image:url('{{ asset('images/listings_single.jpg') }}')"></div>
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="listing_title_container">
						<div class="listing_title">{{ $house['title'] }}</div>
						<p class="listing_text">Read below carefully before make any decisions about this property !</p>
						<div class="room_tags">
							<span class="room_tag">
								<a href="">
									Living Room @if(isset($feature['living_room'])) {{ $feature['living_room'] }} @else 0 @endif
								</a>
							</span>
							<span class="room_tag">
								<a href="">
									Kitchen @if(isset($feature['kitchen'])) {{ $feature['kitchen'] }} @else 0 @endif
								</a>
							</span>
							<span class="room_tag">
								<a href="">
									Toilet @if(isset($feature['toilet'])) {{ $feature['toilet'] }} @else 0 @endif
								</a>
							</span>
							<span class="room_tag">
								<a href="">
									Garage @if(isset($feature['garage'])) {{ $feature['garage'] }} @else 0 @endif
								</a>
							</span>
							<span class="room_tag">
								<a href="">
									Swimming Pool @if(isset($feature['swimming_pool'])) {{ $feature['swimming_pool'] }} @else 0 @endif
								</a>
							</span>
							<span class="room_tag">
								<a href="">
									Patio @if(isset($feature['patio'])) {{ $feature['patio'] }} @else 0 @endif
								</a>
							</span>
							<span class="room_tag">
								<a href="">
									Garden @if(isset($feature['garden'])) {{ $feature['garden'] }} @else 0 @endif
								</a>
							</span>
						</div>
					</div>
				...
				<div class="col-lg-4 listing_price_col clearfix">
					<div class="featured_card_box d-flex flex-row align-items-center trans_300 float-lg-right">
						<img src="{{ $user['image'] }}" alt="https://www.flaticon.com/authors/lucy-g" class="rounded">
						<div class="featured_card_box_content">
							<div class="featured_card_price_title trans_300 badge bg-transparent text-white">Seller: {{ $user['name'] }} | Price:</div>
					...
					<div class="listing_slider_container">
						<div class="owl-carousel owl-theme listing_slider">
							...
							<div class="owl-item listing_slider_item">
								<img src="{{ URL::to('/') }}/{{ $house['image'] }}" alt="https://unsplash.com/@astute" width="100%" height="500px">
							</div>

							<!-- Listing Slider Item -->
							<div class="owl-item listing_slider_item">
								<img src="{{ URL::to('/') }}/{{ $house['image_two'] }}" alt="https://unsplash.com/@astute" width="100%" height="500px">
							</div>

							<!-- Listing Slider Item -->
							<div class="owl-item listing_slider_item">
								<img src="{{ URL::to('/') }}/{{ $house['image_three'] }}" alt="https://unsplash.com/@astute" width="100%" height="500px">
							</div>
						...
						<div class="listing_slider_nav listing_slider_next d-flex flex-row align-items-center justify-content-center trans_200">
							<img src="{{ asset('images/nav_right.png') }}" alt="">
						</div>
			...
			<div class="row listing_content_row">
				...
				<div class="col-lg-8 listing_col">
					...
					<div class="listing_details">
						...
						<p class="listing_details_text">Let's discover more features of this property.</p>
						<div class="rooms">
							...
							<div class="room">
								...
								<div class="room_content">
									...
									<span class="room_number">{{ $feature['bedroom'] }}</span>
								</div>
							</div>
							...
							<div class="room">
								...
								<div class="room_content">
									...
									<span class="room_number">{{ $feature['bathroom'] }}</span>
								</div>
							</div>
							...
							<div class="room">
								<span class="room_title">Living Room</span>
								<div class="room_content">
									<div class="room_image"><img src="images/patio.png" alt=""></div>
									<span class="room_number">{{ $feature['living_room'] }}</span>
								</div>
							</div>
							...
							<div class="room">
								...
								<div class="room_content">
									...
									<span class="room_number">{{ $feature['kitchen'] }}</span>
								</div>
							</div>
					...
					<div class="listing_description">
						...
						<p class="listing_description_text">{{ $house['description'] }}</p>
					</div>
					...
					<div class="listing_additional_details">
						...
						<ul class="additional_details_list">
							<li class="additional_detail"><span>Garden:</span> {{ $feature['garden'] }} garden / gardens</li>
							<li class="additional_detail"><span>Garage:</span> {{ $feature['garage'] }} garage / garages</li>
							<li class="additional_detail"><span>Swimming Pool:</span> {{ $feature['swimming_pool'] }} swimming pool / swimming pools</li>
							<li class="additional_detail"><span>Toilet:</span> {{ $feature['toilet'] }} toilet / toilets</li>
						</ul>
					</div>
					
					<!-- Listing Video -->
					<div class="listing_video">
						<div class="listing_subtitle">Contact</div>
