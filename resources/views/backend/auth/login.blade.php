    ...
    <div class="row justify-content-center">
      ...
      @if(Session::has('success'))
            <div class="alert alert-success">
                {{ Session::get('success') }} <a href="/login/facebook">HERE</a> to login.
            </div>
        @endif
                ...
                <div class="p-5">
                  ...
                  @csrf
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control form-control-user" id="exampleInputEmail" name="email" value="{{ $email }}" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                      @else 
                    ...
                    <div class="form-group">
                    @if(isset($email) && isset($password))
                      <input type="password" class="form-control form-control-user" id="exampleInputPassword" name="password" value="{{ $password }}" placeholder="Password">
                    @else
